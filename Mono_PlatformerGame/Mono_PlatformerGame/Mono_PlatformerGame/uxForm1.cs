...
using Mono_PlatformerGamePipeline;
...
namespace Mono_PlatformerGame
{
    ...
    public partial class uxForm1 : Form
    {
        ...
        public uxForm1(IServiceProvider services)
        {
            ...
            string relativePath = Path.Combine(assemblyLocation, "../../../../../Mono_PlatformerGame/Content/Tiles/");
        ...
        private void SaveLevel(string fileName, string fileNameOnly)
        {
            ...
            {
                IntermediateSerializer.Serialize<LevelContent>(writer, levelSpec, fileName); //TODO
            }
        ...
        private void LoadLevel(string filename)
        {
            ...
            LevelContent levelSpec = null;
            XmlReaderSettings settingsReader = new XmlReaderSettings();
            using (XmlReader reader = XmlReader.Create(filename, settingsReader))
            {
                levelSpec = IntermediateSerializer.Deserialize<LevelContent>(reader, null); //TODO
            }
